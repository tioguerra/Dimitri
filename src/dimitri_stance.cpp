...
int main(int argc, char *argv[])
{
  ...
  {
    // Sets goal positions
    robot.getLeftArm()->getJoint(ARMROLL)->setGoalAngle(DEG2RAD(-60.0));
    robot.getLeftArm()->getJoint(ARMPITCH)->setGoalAngle(DEG2RAD(60.0));
    robot.getLeftArm()->getJoint(ARMYAW)->setGoalAngle(DEG2RAD(0.0));
    robot.getLeftArm()->getJoint(ELBOW)->setGoalAngle(DEG2RAD(-90.0));
    robot.getRightArm()->getJoint(ARMROLL)->setGoalAngle(DEG2RAD(-60.0));
    robot.getRightArm()->getJoint(ARMPITCH)->setGoalAngle(DEG2RAD(60.0));
    robot.getRightArm()->getJoint(ARMYAW)->setGoalAngle(DEG2RAD(0.0));
    robot.getRightArm()->getJoint(ELBOW)->setGoalAngle(DEG2RAD(-90.0));
